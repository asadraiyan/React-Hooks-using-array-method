...
const InputForm = () => {
    ...
    const validate = (values) => {
        ...
        if (values.userName === "") {
            ...
            errors.userName = "Username must have atleast 3 characters and cannot exceed more than 15 characters"
        }
        if (values.email === "") {
        ...
        if (values.password === "") {
            ...
            errors.password = "Must have minimum eight characters, at least one uppercase letter, one lowercase letter and one number"
        }
        if (values.userName === "") {
            errors.userName = "Username is required"
        }
